...
function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        <div className="relative ">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-36 w-36 rounded-full border-[0.35rem] border-white object-cover shadow-xl object-center"
            />
          </motion.div>
      ...
      >
        <span className="font-bold">Hello, I'm Lebga Lesly.</span> I'm a{" "}
